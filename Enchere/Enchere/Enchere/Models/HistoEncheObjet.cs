...
{
    public class HistoEncheObjet
    {
        public HistoEncheObjet(string id, string idEnchere, string nom, string description, string idCategorie, string photo, string piece, string idVendeur, string idAcheteur, decimal prixDepart, decimal prixActuel, DateTime dateDepart, DateTime dateFin, decimal pasDePrix,int etat)
        {
            Id = id;
            IdEnchere = idEnchere;
            Nom = nom;
